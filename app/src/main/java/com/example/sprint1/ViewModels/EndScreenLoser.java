...
public class EndScreenLoser extends Activity {
    ...
    /*
     * Method to initialize and display the EndScreenLoser class and its respective xml file
     * to the user. This xml file is displayed if the user loses the game.
     *
